...
<html lang="en">
  ...
  <title>ticket-foot</title>
</head>
<body class="antialiased dark-mode:bg-gray-90">
{{-- section pour l'entête --}}
    <section class="header z-50 top-0 fixed w-full lg:mb-[5rem]">
        <div class="w-full text-white bg-gray-800 dark-mode:text-gray-200 dark-mode:bg-gray-800">
            <div x-data="{ open: false }" class="flex flex-col max-w-screen-3xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6   lg:items-center lg:justify-between lg:flex-row lg:px-6 xl:items-center xl:justify-between xl:flex-row xl:px-6 sm:items-center sm:justify-between sm:flex-row sm:px-6">
                ...
                <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
                    <div class=" flex items-center gap-10 flex-wrap ">
                        ...
                        <a class="liens" href="#">Blog</a>
                        <a class="liens" href="#">Contact</a>
                    </div>

                    <div @click.away="open = false" class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-900 focus:bg-gray-900 focus:outline-none focus:shadow-outline">
                            <span>Autre evenements</span>
                    ...
                    @if (Route::has('login'))
                        <div class="flex justify-end space-x-6">
                            ...
                            @else
                                <a class="px-4 py-2 mx-2 mt-2 text-sm font-semibold text-gray-100 bg-orange-800 rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-100 focus:text-gray-900 hover:bg-gray-900 focus:bg-green-900 focus:outline-none focus:shadow-outline" href="{{ route('login') }}">Connexion</a>

                                @if (Route::has('register'))
                                    <a class="px-4 py-2 mt-2 text-sm font-semibold text-gray-100 bg-orange-800 rounded-lg dark-mode:bg-gray-700 dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 hover:text-gray-100 focus:text-gray-900 hover:bg-gray-900 focus:bg-green-900 focus:outline-none focus:shadow-outline" href="{{ route('register') }}">Inscription</a>
                                @endif
                            @endauth
                        </div>
                    @endif
