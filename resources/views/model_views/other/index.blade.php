<x-app-layout>
    <div class="creation">
        ...
        <div class="listes">
            <a href="{{ route('other.create') }}">Créer un Other</a>
        </div>
        ...
        <div class="creation">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($others as $matche)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td class="px-6 py-4 text-center">
                                    {{ $matche->event->title }}
                                </td>
                                <td class="px-6 py-4 text-center">
                                    {{ $matche->event->date_start }}
                                </td>
                                <td class="px-6 py-4 text-center">
                                    {{ $matche->event->start_at }}
                                </td>
                                <td class="px-6 py-4 text-center">
                                ...
                                <td class="px-6 py-4 ">
                                    <small class="deux"><a href="{{ route('other.edit', $matche) }}">
                                        <div>
                                            <div>
