    ...
    <form method="post" action="{{route('pdf')}}">
        ...
        <div class="flex space-x-6 ">
            ...
            <a href="{{route('fermer')}}">
                ...
                <button type="button" id="generateButton" class="mt-4 bg-blue-500 text-white rounded py-2 px-4 hover:bg-blue-600">Fermer</button>
            </a>
        </div>
...
<!-- Ajouter un div pour la fenêtre modale (popup) -->
<!-- <div id="previewModal" class="fixed inset-0 flex items-center justify-center hidden bg-black bg-opacity-50">
    <div class="bg-white rounded-lg p-6">
        <h2 class="font-semibold text-lg mb-4">Aperçu de la prévisualisation</h2>
        ...
        <div class="mt-4 flex justify-end">
            ...
            <button id="savePreviewButton" class="bg-blue-500 text-white rounded py-2 px-4 hover:bg-blue-600">Enregistrer</button>
        </div>
    </div>
</div> -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    generateButton.addEventListener('click', function() {
        // Simuler le contenu de la prévisualisation (remplacez par le contenu réel)
        const previewContent = '<p>Contenu de la prévisualisation...</p>';
    ...
    savePreviewButton.addEventListener('click', function() {
        // Enregistrer la prévisualisation (vous pouvez ajouter la logique ici)
        // ...
